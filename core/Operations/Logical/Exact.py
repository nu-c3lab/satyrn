...
class Exact(BooleanOperation):
    def __init__(self):
        name = "exact"
        input_args = [
            OperationArgument(2, 2, [ArgType.Metric, ArgType.Arithmetic, ArgType.Categorical, ArgType.String, ArgType.Datetime, ArgType.Identifier])
        ]
        output_args = [
